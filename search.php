                ...
                <div class="post-container">
                  ...
                  <h2 class="page-heading">Search : <?php echo $search_term;?></h2>
                    <?php
                        ...
                        $sql = "SELECT post.post_id, post.title,post.description, post.post_date, post.post_img,post.author,category.category_name, user.username, post.category, user.first_name FROM post 
                        LEFT JOIN category ON post.category = category.category_id
                        LEFT JOIN user ON post.author = user.user_id
                        WHERE post.title LIKE '%{$search_term}%' OR post.description LIKE '%{$search_term}%'
                        ORDER BY post_id DESC LIMIT {$offset}, {$limit}";

                        $result = mysqli_query($conn, $sql) or die("Query Failed: Result query");
                                    ...
                                    <div class="inner-content clearfix">
                                        ...
                                        <div class="post-information">
                                            ...
                                            <span>
                                                ...
                                                <a href='author.php?search=<?php echo $row['author'];?>'><?php echo $row['first_name'];?></a>
                                            </span>
                                            <span>
                        ...
                        <?php
                            ...
                            // pagination (sql commands are above of the page)
